 ...
 */
export async function createAndAuthenticate(backendUrl, options = {}) {
 ...
 */
export async function authenticateWallet(backendUrl, account, options = {}) {
  const address = account.address.toLowerCase();
 ...
 */
export async function reauthenticate(backendUrl, privateKey, options = {}) {
  const account = privateKeyToAccount(privateKey);
  const token = await authenticateWallet(backendUrl, account, options);
 ...
 */
export async function checkToken(backendUrl, token) {
  try {
